    ...
    return (
        <ModalContainer>
            <ModalBox className="modal-box">
                ...
                <hr />
                <br />
                <Text className="small">Room Price: <span>£{booking.room.price}</span></Text>
                <Text className="small">Amount {booking.paid ? 'Paid' : 'To Be Paid'}: <span>£{booking.amount}</span></Text>
                <Text className="small">Payment Status:
                    <span> {booking.paid ? 'Paid' : 'Not Paid'}</span>
                </Text>
                <ButtonsContainer onClick={() => navigate(`/hotel/${booking.hotel.id}`, {state: booking})}>
