...
const Header = (props) => {
    ...
    return (
        <FixedHeader
            ...
            <Content>
                <div className="brand">
                    <Link to="/"><Logo><img src="https://res.cloudinary.com/dsnontai6/image/upload/v1702558170/ttt-high-resolution-logo-transparent_qw0o1l.png" alt="/" /></Logo></Link>
