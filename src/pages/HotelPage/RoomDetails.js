        ...
        <CardContainer style={{ marginTop: '20px' }}>
            <Flex>
                        ...
                        <Slider {...detailsSettings}>
                            {room.images.map(img => (
                                <div className="banners" key={img.uuid}>
                                    <img src={img.url || "https://res.cloudinary.com/dsnontai6/image/upload/v1702564323/pexels-pixabay-164595_azoulg.jpg"} alt="image" style={{ height: '250px' }} />
                                </div>
                            ))}
                        </Slider>
                    </SliderContainer>
                ...
                <Details style={{ width: '40%', marginLeft: '20px' }} className="details">
                    <Text style={{ marginTop: '30px'}} className="clip">{room.name}</Text>
